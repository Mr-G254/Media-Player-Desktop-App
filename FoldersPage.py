...
class Folders():
    ...
    def folders(frame,button,app):
        ...
        global back2
        back2 = CTkButton(folders_page,text= "Back",font=("TImes",14),height= 27,width=150,fg_color="#283747",corner_radius= 4,border_color="#0967CC",border_width=0,command= lambda: Extra.back(folders_page,button))
        back2.place(x=75,y=335)
